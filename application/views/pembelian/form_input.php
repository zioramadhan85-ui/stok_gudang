...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Tambah Data Pembelian Obat</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    ...
    <div class="form-group row">
        <label for="barangx" class="col-sm-2 col-form-label">Obat</label>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        <div class="col-sm-3 offset-sm-2">
            ...
            <div id="btn-act">
                <button type="button" class="btn btn-success btn-sm" onclick="tambah_cart()">Tambah Obat</button>
            </div>
        </div>
    </div>
