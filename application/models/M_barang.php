...
class M_barang extends CI_Model
{
  ...
  var $column_order = array(null, 'kode_barang', 'nama_barang', 'brand', 'stok', 'harga', 'tanggal_expired', 'active', null);
var $column_search = array('kode_barang', 'nama_barang', 'brand', 'stok', 'harga', 'tanggal_expired', 'active');
