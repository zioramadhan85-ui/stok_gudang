...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-reply"></i> Edit Data Penjualan Obat</h4>
    </div>
</div>
<hr class="mt-0" />
<div id="message">
...
<div class="col-md-12">
    ...
    <div class="form-group row">
        <label for="pembeli" class="col-sm-2 col-form-label">Nama Pasien</label>
        <div class="col-sm-6">
            <input type="text" name="pembeli" id="pembeli" class="form-control form-control-sm <?= (form_error('pembeli')) ? 'is-invalid' : ''; ?>" placeholder="Nama Pasien" value="<?= (set_value('pembeli')) ? set_value('pembeli') : $fdata->nama_pembeli; ?>">
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        <label for="barang-penjualan" class="col-sm-2 col-form-label">Obat</label>
        <div class="col-sm-6">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control form-control-sm qty" id="sisa" placeholder="Stok Obat" readonly>
        </div>
    </div>
    <div class="form-group row">
