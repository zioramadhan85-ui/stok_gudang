...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-cubes"></i> Edit Data Stok Obat</h4>
    </div>
</div>
<hr class="mt-0" />
<?= form_open(); ?>
<div class="col-md-8">
    ...
    <div class="col-sm-6">
        <input type="date" class="form-control form-control-sm <?= (form_error('tanggal_expired')) ? 'is-invalid' : ''; ?>" id="tanggal_expired" name="tanggal_expired" value="<?= (set_value('tanggal_expired')) ? set_value('tanggal_expired') : $barang->tanggal_expired; ?>">
        <div class="invalid-feedback">
